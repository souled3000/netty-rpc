...
public class WsClient {
	public final String nn = "60";
	public final SocketAddress serve=new InetSocketAddress("193.168.1."+nn, 1235);
	public final String wsurl = "ws://193.168.1."+nn+":1235/ws";
	public final SocketAddress lclAdr = new InetSocketAddress("193.168.1."+nn, 20001);
	...
	public static void f()throws Exception{
		URL url = new URL("http://193.168.1.60:8181/mobile/cometadr");
		...
		String content = "cookie=" + URLEncoder.encode("MTZ8MzAwfDFkM2U0ZDUyYWMxOTQ1MjQ4ODQ1OTM4ZTc3NTgyMTE2ODUwOTlk-1EE42E560877A9900D86F7EA6A7A31DF", "utf-8");
