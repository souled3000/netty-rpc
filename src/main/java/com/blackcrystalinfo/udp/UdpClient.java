...
//		boot();
		System.out.println(ByteUtil.toHex(NumberByte.int2Byte(Integer.MIN_VALUE)));
		System.out.println(ByteUtil.toHex(NumberByte.int2Byte(-1)));
		System.out.println(ByteUtil.toHex(NumberByte.int2Byte(Integer.MAX_VALUE)));
	}
